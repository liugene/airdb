...
class SQLParser:
    ...
    def __init__(self):
        ...
        self.__pattern_map = {
            ...
            'INSERT': r'(INSERT|insert) (INTO|into) (.*)\((.*)\) (VALUE|value)\((.*)\)'
        }
    ...
    def parse(self, statement):
        ...
        base_statement = self.__filter_space(statement[0].splite(" "))
        ...
        if len(base_statement) < 2 and base_statement[0] not in ['exit', 'quit']:
            ...
            if action is not None or 'type' not in action:
                raise Exception('')
